...
import org.genevaers.sycadas.grammar.ExtractFilterParser.GoalContext;

public class ExtractFilterSycada implements SyntaxChecker, DependencyAnalyser {

	private GoalContext tree;
	private ExtractFilterDependencyListener dependencies;
	...
	public void processLogic(String logicText) throws IOException {
        ...
        ExtractFilterLexer lexer = new ExtractFilterLexer(input);
        CommonTokenStream tokens = new CommonTokenStream(lexer);
        ExtractFilterParser parser = new ExtractFilterParser(tokens);
	...
	public void generateDependencyDataFrom(SycadaDataProvider dataFromHere) {
		dependencies = new ExtractFilterDependencyListener();
