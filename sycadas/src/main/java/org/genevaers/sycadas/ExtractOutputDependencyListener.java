...
import org.genevaers.sycadas.grammar.ExtractOutputBaseListener;
import org.genevaers.sycadas.grammar.ExtractOutputParser;


public class ExtractOutputDependencyListener extends ExtractOutputBaseListener {
	...
	public void enterLookupRef(ExtractOutputParser.LookupRefContext ctx) {
	...
	@Override
	public void exitLookupRef(ExtractOutputParser.LookupRefContext ctx) {
		// TODO Auto-generated method stub

	}

	public void enterFieldRef(ExtractOutputParser.FieldRefContext ctx) {
		// TODO Auto-generated method stub

	}

	@Override
	public void exitFieldRef(ExtractOutputParser.FieldRefContext ctx) {
		StringBuilder sb = new StringBuilder(ctx.getText());
		sb.deleteCharAt(0);
		sb.deleteCharAt(sb.length()-1);
	...
	@Override
	public void enterLookupField(ExtractOutputParser.LookupFieldContext ctx) {
		// TODO Auto-generated method stub

	}

	@Override
	public void exitLookupField(ExtractOutputParser.LookupFieldContext ctx) {
		StringBuilder sb = new StringBuilder(ctx.getText());
		sb.deleteCharAt(0);
		sb.deleteCharAt(sb.length()-1);
		String fullName = sb.toString();
	...
	@Override
	public void enterWriteExit(ExtractOutputParser.WriteExitContext ctx) {
		// TODO Auto-generated method stub

	}

	@Override
	public void exitWriteExit(ExtractOutputParser.WriteExitContext ctx) {
		StringBuilder sb = new StringBuilder(ctx.getText());
		sb.deleteCharAt(0);
		sb.deleteCharAt(sb.length()-1);
	...
	@Override 
	public void exitFile(ExtractOutputParser.FileContext ctx) { 
		StringBuilder sb = new StringBuilder(ctx.getText());
		sb.deleteCharAt(0);
		sb.deleteCharAt(sb.length()-1);
		String fullName = sb.toString();
