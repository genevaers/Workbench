...
public class CRHandler extends SetHandler{
    ...
    public static void set(SAFRComponent comp, String[] words) {
        ControlRecord cr = (ControlRecord)comp;
        ...
        case "first fiscal month":
            cr.setFirstFiscalMonth(Integer.valueOf(words[nextWord]));
            break;
        case "beginning period":
            cr.setBeginPeriod(Integer.valueOf(words[nextWord]));
            break;
        case "ending period":
            cr.setEndPeriod(Integer.valueOf(words[nextWord]));
            break;
        case "comments":
            cr.setComment(value);
            break;
