...
public class DB2LookupPathStepDAO implements LookupPathStepDAO {

	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2LookupPathStepDAO");
	...
	public DB2LookupPathStepDAO(Connection con, ConnectionParameters params,
	...
	public List<LookupPathStepTransfer> getAllLookUpPathSteps(
		...
		try {
			...
			logger.log(Level.INFO, selectString);
	...
	private LookupPathStepTransfer createLookupPathStep(
	    ...
	    SAFRApplication.getTimingMap().startTiming("DB2LookupPathStepDAO.createLookupPathStep");
		...
		SAFRApplication.getTimingMap().stopTiming("DB2LookupPathStepDAO.createLookupPathStep");
	...
	private LookupPathStepTransfer updateLookupPathStep(
	    ...
	    SAFRApplication.getTimingMap().startTiming("DB2LookupPathStepDAO.updateLookupPathStep");
		...
		SAFRApplication.getTimingMap().stopTiming("DB2LookupPathStepDAO.updateLookupPathStep");
    ...
    public void persistLookupPathStepsSourceFields(
        ...
        for (LookupPathSourceFieldTransfer sourceField : sourceFieldsTrans) {
            countCreate++;
            if(sourceField.getSourceXLRFLDId() == null)
            	sourceField.setSourceXLRFLDId(0);
            if(sourceField.getSourceXLRFileId() == null) 
            	sourceField.setSourceXLRFileId(0);
    ...
    private List<LookupPathSourceFieldTransfer> createLookupPathStepSourceFields(
        ...
        try {    
            SAFRApplication.getTimingMap().startTiming("DB2LookupPathStepDAO.createLookupPathStepSourceFields");
    ...
    public void removeLookupPathStepsSourceField(List<Integer> lkupPathStepIds,
            Integer environmentId) throws DAOException {
        try {
            SAFRApplication.getTimingMap().startTiming("DB2LookupPathStepDAO.removeLookupPathStepsSourceField");
        ...
        SAFRApplication.getTimingMap().stopTiming("DB2LookupPathStepDAO.removeLookupPathStepsSourceField");
