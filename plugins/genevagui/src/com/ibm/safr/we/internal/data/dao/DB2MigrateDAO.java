...
public class DB2MigrateDAO implements MigrateDAO {

	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2MigrateDAO");
	 ...
	 *            workbench.
	 */
	public DB2MigrateDAO(Connection con, ConnectionParameters params,
