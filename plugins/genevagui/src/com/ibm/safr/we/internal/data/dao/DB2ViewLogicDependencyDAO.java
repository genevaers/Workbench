 ...
 */
public class DB2ViewLogicDependencyDAO implements ViewLogicDependencyDAO {

	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2ViewLogicDependencyDAO");
	 ...
	 *            workbench.
	 */
	public DB2ViewLogicDependencyDAO(Connection con,
			...
			while (true) {
				try {
					...
					for (ViewLogicDependencyTransfer vldTrans : viewLogicDepTfrList) {
						...
						pst1.setInt(i++, vldTrans.getLookupPathId() == null ? 0 : vldTrans.getLookupPathId());
						pst1.setInt(i++, vldTrans.getLrFieldId() == null ? 0 : vldTrans.getLrFieldId());
						pst1.setInt(i++, vldTrans.getUserExitRoutineId() == null ? 0 : vldTrans.getUserExitRoutineId());
						pst1.setInt(i++, vldTrans.getFileAssociationId() == null ? 0 : vldTrans.getFileAssociationId());
