 ...
 * 
 */
public class DB2CodeSetDAO implements CodeSetDAO {
	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2CodeSetDAO");
	 ...
	 *            workbench.
	 */
	public DB2CodeSetDAO(Connection con, ConnectionParameters params,
