...
public class DB2PhysicalFileDAO implements PhysicalFileDAO {

	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2PhysicalFileDAO");
	 ...
	 *            workbench.
	 */
	public DB2PhysicalFileDAO(Connection con, ConnectionParameters params,
	...
	private PhysicalFileTransfer createPhysicalFile(
	    ...
	    SAFRApplication.getTimingMap().startTiming("DB2PhysicalFileDAO.createPhysicalFile");	    
		...
		SAFRApplication.getTimingMap().stopTiming("DB2PhysicalFileDAO.createPhysicalFile");
	...
	private PhysicalFileTransfer updatePhysicalFile(
			PhysicalFileTransfer physicalFile) throws DAOException,
			SAFRNotFoundException {
	    SAFRApplication.getTimingMap().startTiming("DB2PhysicalFileDAO.updatePhysicalFile");
		...
		try {
			...
			SAFRApplication.getTimingMap().stopTiming("DB2PhysicalFileDAO.updatePhysicalFile");
