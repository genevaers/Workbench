...
public class DB2OldCompilerDAO implements OldCompilerDAO {

	static transient Logger logger = Logger
	.getLogger("com.ibm.safr.we.internal.data.dao.DB2OldCompilerDAO");
	...
	public DB2OldCompilerDAO(Connection con, ConnectionParameters params,
