 ...
 * 
 */
public class DB2EnvironmentDAO implements EnvironmentDAO {

	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2EnvironmentDAO");
	 ...
	 *            workbench.
	 */
	public DB2EnvironmentDAO(Connection con, ConnectionParameters params,
	...
	//This query does not appear to be used.
		...
		try {
			...
			while (true) {
				try {
					...
					proc.setString(1, environment.getName());
					proc.setString(2, environment.getComments());
					proc.setString(3, safrLogin.getUserId());
					proc.setString(4, environment.getControlRecClientName());
