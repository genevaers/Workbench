...
public class PGViewSortKeyDAO implements ViewSortKeyDAO {

	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.PGViewSortKeyDAO");
	 ...
	 *            workbench.
	 */
	public PGViewSortKeyDAO(Connection con, ConnectionParameters params,
		...
		try {
			...
			if (!isImportOrMigrate) {
				statement = "UPDATE " + params.getSchema()
						...
						+ " LASTMODTIMESTAMP = CURRENT_TIMESTAMP, LASTMODUSERID = ? WHERE "
