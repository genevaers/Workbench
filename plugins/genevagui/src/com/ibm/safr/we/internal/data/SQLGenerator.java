...
public class SQLGenerator {
	...
	public String getInsertStatement(String schema, String table, String id,
        ...
        String statement;       
        if (schema == null) {
            statement = "SELECT " + result + " FROM FINAL TABLE (INSERT INTO " + table + " (";
        } else {
            statement = "SELECT " + result + " FROM FINAL TABLE (INSERT INTO " + schema + "." + table + " (";
        }		
		statement += nameStr + ") VALUES (" + valueStr + ") )";
	...
	public String getUpdateStatement(String schema, String table,
        ...
        if (result.isEmpty()) {
            ...
            if (schema == null) {
                statement = "SELECT " + result + " FROM FINAL TABLE (Update " + table + " Set ";
            } else {
                statement = "SELECT " + result + " FROM FINAL TABLE (Update " + schema + "." + table + " Set ";
            }
        }
