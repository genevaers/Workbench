...
public class DB2GroupDAO implements GroupDAO {
	...
	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2GroupDAO");
	...
	public DB2GroupDAO(Connection con, ConnectionParameters params,
        ...
        try {
            ...
            if (compType == ComponentType.PhysicalFile) {
                ...
                selectString = "Select A.VIEWFOLDERID, B.NAME, A.RIGHTS "
                        ...
                        + " Where "+ " A.VIEWFOLDERID = B.VIEWFOLDERID AND A.ENVIRONID = ?  AND B.ENVIRONID = ? "
                        + " AND A.GROUPID = ? ";
    ...
    public void persistComponentEditRights(ComponentType compType,
        ...
        try {
            ...
            if (!xml.equals("")) {
                String statement = generator.getStoredProcedure(schema,
                        "INSSECGRPRGHT", 4);
