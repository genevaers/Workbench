...
public class DB2HeaderFooterDAO implements HeaderFooterDAO {
	static transient Logger logger = Logger
			.getLogger("com.ibm.safr.we.internal.data.dao.DB2HeaderFooterDAO");
	 ...
	 *            workbench.
	 */
	public DB2HeaderFooterDAO(Connection con, ConnectionParameters params,
