...
public class ViewFolderViewAssociation extends ComponentAssociation {

    public ViewFolderViewAssociation(ComponentAssociationTransfer trans,
    ...
    public ViewFolderViewAssociation(
        SAFREnvironmentalComponent associatingComponent,
        Integer associatedComponentId, String associatedComponentName,
        EditRights associatedCompRights) throws SAFRException {
        super(associatingComponent, associatedComponentId, associatedComponentName, associatedCompRights);
    }
