...
public interface LRInformationProvider {
	/**
	 * Returns the LR Index Transfer object associated with an LR.
	 * 
	 * @param lrId
	 * @return
	 */
	...
	/**
	 * Returns a list of LR Index Field Transfer objects associated with an LR
	 * index.
	 * 
	 * @param lrIndexId
	 * @return
