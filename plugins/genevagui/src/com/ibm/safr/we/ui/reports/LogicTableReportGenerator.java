...
public class LogicTableReportGenerator implements IReportGenerator {
    static transient Logger logger = Logger.getLogger("com.ibm.safr.we.ui.reports.LogicTableReportGenerator");
	private LogicTableHTMLReport htmlReport = new LogicTableHTMLReport();
	...
	public LogicTableReportGenerator(List<Integer> inputids) throws SAFRException {
		ids = inputids;
	}
	 ...
	 */
	public LogicTableReportGenerator(View view) throws DAOException, SAFRException {
	}
