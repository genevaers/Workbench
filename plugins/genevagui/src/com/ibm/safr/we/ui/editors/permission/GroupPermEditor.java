...
public class GroupPermEditor extends SAFREditorPart implements ISearchablePart {
    ...
    public static String ID = "SAFRWE.GroupPermissionsEditor";
    ...
    public void createPartControl(Composite parent) {
        ...
        form.setText("Permissions by Group");
        form.getBody().setLayout(new FormLayout());        
        form.getBody().setSize(new Point(100,100));
        
        // create subsections
        GroupPermGroup permGroup = new GroupPermGroup();
        GroupPermEnvironments permEnv = new GroupPermEnvironments();
        PermPermissions permPerm = new PermPermissions();
        PermEditRights permRight = new PermEditRights();
        
        mediator = new GroupPermMediator(this, permGroup, permEnv, permPerm, permRight);
        
        permGroup.setMediator(mediator);
    ...
    public void storeModel() throws DAOException, SAFRException {
        mediator.getCurrentGroup().storeAssociatedEnvironments();
        mediator.getCurrentGroup().storeComponentRights();
        mediator.onSave();
    }
    ...
    public GroupEnvironmentAssociation getCurrentEnvSelection() {
    ...
    protected void setPopupEnabled(boolean enabled) {
        ...
        OpenEditorPopupState service = (OpenEditorPopupState) sourceProviderService
                .getSourceProvider(OpenEditorPopupState.GRPPERM);
