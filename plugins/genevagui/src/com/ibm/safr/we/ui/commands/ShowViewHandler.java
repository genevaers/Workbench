...
public class ShowViewHandler extends AbstractHandler implements IHandler {
    ...
    private static final Object VIEW_ACTIVATION_LOG_OLD = "SAFRWE.ActivationLogViewOld";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
            ...
            } else if (event.getCommand().getId().equals(VIEW_ACTIVATION_LOG_OLD)) {
                HandlerUtil.getActiveWorkbenchWindow(event).getActivePage()
                    .showView(ActivationLogViewOld.ID);
