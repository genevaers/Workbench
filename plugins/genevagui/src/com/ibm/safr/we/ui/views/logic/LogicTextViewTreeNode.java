...
public class LogicTextViewTreeNode {
	...
	public enum TreeItemId {
		...
		ISNOTSPACES, REPEAT, RUNDAY, RUNMONTH, RUNYEAR, WRITE, /**
		 * 
		 * 
		 * 
		 * 
		 ...
		 * Logic Text Tree.
		 */
		USEREXIT, SOURCEINPUT, SOURCEVIEW, SOURCEDATA, DESTINATIONEXTRACT, DESTINATIONFILE, LOGICALOPERATORS, AND, OR, NOT, ARITHMETICOPR, ADD, MINUS, MUL, DIVIDE, COMPARISIONOPR, BEGINSWITH, ENDWITH, CONTAINS, GREATERTHAN, LESSTHAN, EQUALSTO, GREATERTHANEQUALS, LESSTHANEQUALS, NOTEQUALS, FIELDSORCOL, LOOKUPPATHS, LOOKUPSYMBOLS, WRITEPARAM, /**
		 * 
		 * 
		 * 
		 * 
