...
public class EnvDeveloperRights extends EnvRoleRights {

    public EnvDeveloperRights() {
    ...
    public EditRights getComponentRight(ComponentType type) {
        ...
        else if (type.equals(ComponentType.ControlRecord) ||
            type.equals(ComponentType.Environment)) {
