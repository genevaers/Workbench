...
public class DSNMOD1 {

    private static final Logger logger = Logger.getLogger(DSNMOD1.class.getName());

    private static final Logger slogger = Logger.getLogger(DSNMOD1.class.getName());
