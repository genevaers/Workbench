...
public abstract class SAFRDialogCellEditor extends CellEditor {
     ...
     */
    protected SAFRDialogCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    protected SAFRDialogCellEditor(Composite parent, int style) {
        super(parent, style);
        this.sparent = parent;
    }
        ...
        if (buttonFocusListener == null) {
            buttonFocusListener = new FocusListener() {
                ...
                public void focusLost(FocusEvent e) {
                    SAFRDialogCellEditor.this.focusLost();
                    UIUtilities.rememberFocusControl(editor.getParent());                    
                }
            };
        }
