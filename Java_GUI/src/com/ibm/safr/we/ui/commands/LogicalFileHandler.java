...
public class LogicalFileHandler extends AbstractHandler implements IHandler {

	public Object execute(ExecutionEvent event) throws ExecutionException {

		LogicalFile logicalFile = SAFRApplication.getSAFRFactory()
				.createLogicalfile();
		LogicalFileEditorInput input = new LogicalFileEditorInput(logicalFile,
		...
		try {
			...
			UIUtilities.handleWEExceptions(e,
			    "Unexpected error occurred while opening logical file editor.",null);
		}
