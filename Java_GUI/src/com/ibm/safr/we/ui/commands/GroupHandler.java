...
public class GroupHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			UIUtilities.handleWEExceptions(e,"Unexpected error occurred while opening group editor.",null);
		}
