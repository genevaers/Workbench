...
public class LogicalFileOpenEditor extends AbstractHandler implements IHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (page != null) {
            ...
            if (editor.getMouseHover() == MouseHover.PFTABLE) {
                ...
                if (ass != null) {                    
                    EditorOpener.open(ass.getAssociatedComponentIdNum(), ComponentType.LogicalRecord);
                }
            }
        }
        return null;
