...
/**
 * This class provides sorting functionality for the Batch Activate Views.
 * Contains a function to sort the selected column of the table in the Batch
 * Activate Lookup Paths editor in ascending/descending order.
 */
public class BatchActivateViewsTableSorter extends ViewerSorter {
	...
	public BatchActivateViewsTableSorter(int propertyIndex, int dir) {
		...
		case 1:
			if ((batchComponent1.getResult() == null)
				...
				if (batchComponent1.getResult() == ActivityResult.PASS) {
					str1 = PASS;
				} else if (batchComponent1.getResult() == ActivityResult.WARNING) {
					str1 = WARNING;
				...
				if (batchComponent2.getResult() == ActivityResult.PASS) {
					str2 = PASS;
				} else if (batchComponent2.getResult() == ActivityResult.WARNING) {
					str2 = WARNING;
