...
public class ActivateLookupPathsError {
    static final Logger logger = Logger.getLogger("com.ibm.safr.we.ui.editors.batchlookup.ActivateLookupPathsError");
    ...
    public ActivateLookupPathsError(ActivateLookupPathsMediator mediator, Composite parent) {
        super();
        this.mediator = mediator;
        this.parent = parent;
    }

    // Section to display the errors of a failed lookup path.
    protected void create() {
        ...
        dataErrors.left = new FormAttachment(mediator.getSectionLookups(), 5);
        dataErrors.top = new FormAttachment(mediator.getSectionEnvironment(), 10);
     ...
     * @param visible
     */
    protected void showSectionErrors(Boolean visible) {
        BatchComponent view = mediator.getLookupSelection();
        if (view != null) {
