...
--***********************************************************************
CREATE OR REPLACE FUNCTION :schemaV.updateViewColumnSourceWithId (  
 ...
 DOC = XMLPARSE (DOCUMENT XIN);
  ...
  LOOP    
    UPDATE VIEWCOLUMNSOURCE SET
     ...
     CONSTVAL=OP.CONSTVAL,LOOKUPID=OP.LOOKUPID,
     LRFIELDID=OP.LRFIELDID,
     EFFDATEVALUE=OP.EFFDATEVALUE,EFFDATETYPE=OP.EFFDATETYPE,
