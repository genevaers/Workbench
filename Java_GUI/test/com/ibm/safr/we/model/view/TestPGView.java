...
public class TestPGView extends TestCase {
    ...
    public void dbStartup() {
        try {
			TestDataLayerHelper.setPostgres(true);
            helper.initDataLayer();
            //CompilerFactory.createNewCompiler();
    ...
    public void testStore() throws SAFRException {
        ...
        try {
            ...
            fileAssoc = SAFRAssociationFactory.getLogicalFileToPhysicalFileAssociation(1, 1);
            view1.setName("Test22334");
            view1.setExtractWorkFileNo(5);
            view1.setExtractFileAssociation(null);
            ...
            view1.setWriteExit(null);
            view1.setFormatExit(null);
        ...
        try {
            ...
            assertEquals(new Boolean(false), view1.isFormatPhaseRecordAggregationOn());
            ...
            assertNull(view1.getWriteExit());
            assertNull(view1.getFormatExit());
            ...
            assertNull(view1.getExtractFileAssociation());
...
//TODO Fix me
//	private void testWithHeaderFooter(Code statusCode,
//			HeaderFooterItem hfItem1, HeaderFooterItem hfItem2,
//			HeaderFooterItem hfItem3, Boolean noException,
