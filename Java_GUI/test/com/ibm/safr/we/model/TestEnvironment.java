...
public class TestEnvironment extends TestCase {
	...
	public void testGetSetComment() {
		dbStartup();
		Environment env = SAFRApplication.getSAFRFactory().createEnvironment();
		assertEquals(env.getComment(), null);

		env.setComment("testComment1");
		assertEquals(env.getComment(), "testComment1");

		env.setComment("testComment2");
		assertEquals(env.getComment(), "testComment2");

		env.setComment("");
		assertEquals(env.getComment(), "");
	...
	public void testGetCreateBy() {
		...
		try {
			env = SAFRApplication.getSAFRFactory().getEnvironment(10);
		...
		try {
			...
			assertEquals(env.getCreateBy(), createdBy);
			pst.close();
	...
	public void testGetCreateTime() {
		...
		try {
			...
			assertEquals(env.getCreateTime(), createdTime);
			pst.close();
		} catch (SQLException e) {
			e.printStackTrace();
			assertFalse(true);
	...
	public void testGetModifyBy() {
		...
		try {
			...
			assertEquals(env.getModifyBy(), modifyBy);
			pst.close();
		} catch (SQLException e) {
			e.printStackTrace();
			assertFalse(true);
	...
	public void testGetModifyTime() {
		...
		try {
			...
			assertEquals(env.getModifyTime(), modifyTime);
			pst.close();
		} catch (SQLException e) {
			e.printStackTrace();
			assertFalse(true);
	...
	public void testGetSetName() {
		dbStartup();
		Environment env = SAFRApplication.getSAFRFactory().createEnvironment();
		assertEquals(env.getName(), null);

		env.setName("testName1");
		assertEquals(env.getName(), "testName1");

		env.setName("testName2");
		assertEquals(env.getName(), "testName2");
	...
	public void testInitialize() {
		...
		// assert no exception when initializing with null's
		env.initialize(null, null);

		// assert no exception when initializing with empty strings
		env.initialize("", "");

		// assert no exception with normal values
		env.initialize("controlRecClient1", "groupName1");

		// assert exception
		env.initialize("controlRecClient2", "groupName2");
